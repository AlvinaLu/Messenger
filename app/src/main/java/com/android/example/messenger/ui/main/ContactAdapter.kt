...
class ContactAdapter(private val interaction: Interaction? = null) :
    ListAdapter<ContactsModel, ContactAdapter.ContactViewHolder>(PoiModelDiffCallback()) {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContactViewHolder {
        return ContactViewHolder.from(parent, interaction)
    }
    ...
    class ContactViewHolder(
        ...
        fun bind(item: ContactsModel) {
            ...
            val generatedAvatar = AvatarGenerator.AvatarBuilder(binding.root.context)
                .setLabel(item.username.uppercase())
                .setAvatarSize(56)
                .setTextSize(15)
                .toSquare()
        ...
        companion object {
            fun from(parent: ViewGroup, interaction: Interaction?): ContactViewHolder {
                ...
                return ContactViewHolder(binding, interaction)
            }
        }
    }
